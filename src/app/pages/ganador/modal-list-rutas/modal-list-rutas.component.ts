...
@Component({
  selector: 'app-modal-list-rutas',
  templateUrl: './modal-list-rutas.component.html',
  styleUrls: ['./modal-list-rutas.component.scss']
})
export class ModalListRutasComponent implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<ModalListRutasComponent>,
 ...
 async  loadData(_data: any) {
     let resp = await this.winnerSvr.getRutasPorGanadorNegocio(_data.idGanador,_data.idNegocio)
...
async  exportToExcel() {
    ...
    this.exportSvc.exportToExcel(json, 'Datalle Ganadores por Ruta');
  }
 ...
 async exportToPDF() {
    ...
    this.exportSvc.exportPdf(json, 'Detalle Ganadores por Ruta',7,true);
  }
