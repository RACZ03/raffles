...
@Component({
  selector: 'app-limits-super-admin',
  templateUrl: './limits-super-admin.component.html',
  styleUrls: ['./limits-super-admin.component.scss']
})
export class LimitsSuperAdminComponent implements OnInit {
