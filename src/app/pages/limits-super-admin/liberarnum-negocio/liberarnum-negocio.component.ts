...
@Component({
  selector: 'app-liberarnum-negocio',
  templateUrl: './liberarnum-negocio.component.html',
  styleUrls: ['./liberarnum-negocio.component.scss']
})
export class LiberarnumNegocioComponent implements OnInit {
